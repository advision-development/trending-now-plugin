 ...
 * Card layout.
 *
 * Override from a theme at {theme}/trending-now/widget-cards.php.
 *
...
$p = $prefix;
?>
<section class="<?php echo esc_attr( $p ); ?> <?php echo esc_attr( $p ); ?>--cards" aria-labelledby="<?php echo esc_attr( $heading_id ); ?>">
	<?php if ( '' !== $args['heading'] ) : ?>
